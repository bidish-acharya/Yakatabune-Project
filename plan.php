...
<body>
	<div class="inner-banner plan" id="banner">
    ...
    <div class="breadcrumb m-auto"><h5><span class="text-uppercase">top</span> <span class="mr-2 ml-2"> > </span><span>選べる料理コース</span></h5></div>
	<div class="container-fluid">
        <div class="row">
    <div class="page-heading">
    <h2>選べる遊覧プラン</h2>
    <p>ゑびやの屋形船では、遊覧プランを３コースご用意しております。桜の時期は隅田川・浅草へ。宴会は夜景のきれいなお台場でゆったりと。観光にはお台場とスカイツリーなど季節や状況によりおすすめコースをご提案いたします。</p>
            </div>
            
            </div>
        </div>
    
    <div class="course-head greenBackDrop">
        <h2>A.お台場ベイコース</h2></div>
    <div class="container-fluid">
            
    <div class="row course-item">
        <div class="col-md-6 plan-img1"></div>
        <div class="col-md-6 plan-content">
        <p>ゑびや一番人気のお台場コース。大迫力のレインボーブリッジをくぐり、お台場を配した東京港の壮大な景色をゆっくりと満喫できる贅沢なコースです。</p>
            <p>【おすすめシチュエーション】<br>ゆったりお台場の風景を満喫したい方におすすめです。停泊時間が長く、台場内は揺れも少ないので宴会やパーティーで盛り上がりたい方、カラオケを楽しみたい方に最適。</p>
            
            <div class="plan-img-r1 plan-img-r"></div>
            <div class="plan-img-r2 plan-img-rb"></div>
        </div>
    </div>
    </div>
    
       <div class="course-head blueBackDrop">
        <h2>B.お台場〜清洲橋コース</h2></div>
    <div class="container-fluid">
            
    <div class="row course-item">
        <div class="col-md-6 plan-img2"></div>
        <div class="col-md-6 plan-content">
        <p>お台場を経由しスカイツリーの見える隅田川清洲橋へ。時間的には少し忙しいですが、お台場の絶景と東京スカイツリーを両方楽しめる欲張りコースです。</p>
            <p>【おすすめシチュエーション】<br>東京観光など、たくさんの東京の景色をご覧になりたい方におすすめです。</p>
            
            <div class="plan-img-r3 plan-img-r"></div>
            <div class="plan-img-r4 plan-img-rb"></div>
        </div>
    </div>
    </div>
    
       <div class="course-head purpleBackDrop">
        <h2>C.浅草スカイツリーコース</h2></div>
    <div class="container-fluid">
            
    <div class="row course-item">
        <div class="col-md-6 plan-img3"></div>
        <div class="col-md-6 plan-content">
        <p>隅田川に架かる数々の個性豊かな橋をめぐりながら、賑わう浅草、桜橋までを往復するコースです。目の前に佇む高さ634 mの東京スカイツリーは迫力満点。桜の季節におすすめです。</p>
            <p>【おすすめシチュエーション】<br>お花見、隅田川橋巡り、スカイツリーの絶景を満喫したい方</p>
            <div class="plan-img-r5 plan-img-r"></div>
            <div class="plan-img-r6 plan-img-rb"></div>
                </div>
        </div>
    </div>
    </div>
